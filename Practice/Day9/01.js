...
// countries.forEach((values)=>
// {
//     console.log(values)
// })

// const newarr=names.map((val)=>{
//     return val.toUpperCase();
// })
// console.log(newarr);

// const countrieslength=countries.map((val)=>{
//     return val.length;
// })
...
// const numberarraysquare=numbers.map((num)=>{
//     return num **2
// })
// console.log(numberarraysquare)
// // console.log(newarr);
...
// const countriesfiltersix=countries.filter((country)=>{
//     return country.length>6;
// })
// console.log(countriesfiltersix)


// const countriesfilterstart=countries.filter((country)=>{
//     return country.startsWith('F');
// })
// console.log(countriesfilterstart)


// const filterprices=products.filter((product)=>{
...
//     return newarr;
// }
// const a=Stringlist(numbers)
// console.log(a);



// const sum=numbers.reduce((acc,index)=>{
//     return acc+index
// },0)
// console.log(sum)
...
const total_price=products.reduce((acc,index)=>{
...
const  occurences=countries.reduce((acc,cur)=>{
    const startletter=cur[0]
    acc[startletter]=(acc[startletter]||0)+1;
    return acc;
...
// const letters=countries.map((values,i)=>{
//     return values[i];
// })
// console.log(letters)
const countriess = [
...
const sort=countriess.sort((a,b)=>{
if(a.name<b.name){
    return -1;
}
if(a.name>b.name){
...
let mostSpoken = Object.entries(countriess.reduce((langs, obj) => { obj.languages.forEach(x => langs.push(x));
    return langs;
 }, []).reduce((dict, lang) => {
